...
<html lang="en">
  ...
  <h1 class="text-center item animated fadeInRight">Регистрация Черный список</h1>
...
<form id="regForm" class="item animated fadeInRight">
  ...
  <button id="regBtn" type="submit" class="btn btn-primary">Регистрация</button>
</form>
